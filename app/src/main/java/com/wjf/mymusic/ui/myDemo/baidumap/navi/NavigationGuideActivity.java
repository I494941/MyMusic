...
/**
 * Created by wangshuai on 2018/12/20 0020 10:59.
 */
public class NavigationGuideActivity extends AppCompatActivity {

    private static final String TAG = NavigationGuideActivity.class.getName();
    ...
    private void showOverlay() {
        ...
        BNItemizedOverlay overlay = new BNItemizedOverlay(
                NavigationGuideActivity.this.getResources().getDrawable(R.drawable
                        .navi_guide_turn));
