 ...
 */
public class EventBusSecondActivity extends BaseToolbarActivity {
    ...
    protected void initViewsAndEvents() {
        ...
        mTv.setText("EventBusSecondActivity");
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tv:
                startActivity(EventBusThirdActivity.class);
                break;
        }
    }
    ...
    public void Event(MessageEvent messageEvent) {
        ...
        LogUtil.e("1111111+EventBusSecondActivity", " = ");
        LogUtil.e("1111111+EventBusSecondActivity", " = " + messageEvent.getMessage());
    }
    ...
    public void Event(MessageEvent2 messageEvent2) {
        ...
        LogUtil.e("2222222+EventBusSecondActivity", " = ");
        LogUtil.e("2222222+EventBusSecondActivity", " = " + messageEvent2.getMessage());
    }
